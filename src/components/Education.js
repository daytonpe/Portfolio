      ...
      <div class="section" id="educationDiv">
				<div id="eduContent">
					...
					<div class="row educationRow">
						<div class="col col-md-4 logoCol">
							<img class="eduLogo" src="/wp-content/themes/twentyfifteen-child/img/mit.png" alt=""/>
						</div>
              ...
              <p>Along with my studies I was lucky enough to play four years of varsity baseball, competing in the D3 NCAA tournament three times and raising the schools first conference championship banner my senior year.</p>
					...
					<div class="row educationRow">
						<div class="col col-md-4 logoCol col-md-push-8">
							<img class="eduLogo" src="/wp-content/themes/twentyfifteen-child/img/utd.png" alt=""/>
						</div>
