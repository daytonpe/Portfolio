      ...
      <div className="section" id="personalDiv">
				...
				<div className="row personalRow">
					...
					<div className="col col-md-6 personalCol">
						<img className="personalImg" src="/wp-content/themes/twentyfifteen-child/img/rainier3.jpg" alt=""/>
					...
					<div className="col col-md-6 personalCol">
						<img className="personalImg" src="/wp-content/themes/twentyfifteen-child/img/marathon.jpg" alt=""/>
						<div className="overlay">
					    <div className="projectInfo">
								<h4>Running</h4>
				...
				<div className="row personalRow">
					<div className="col col-md-6 personalCol">
						<img className="personalImg" src="/wp-content/themes/twentyfifteen-child/img/food.jpg" alt=""/>
						<div className="overlay">
					    <div className="projectInfo">
								<h4>Food &amp; Drink</h4>
					...
					<div className="col col-md-6 personalCol">
						<img className="personalImg" src="/wp-content/themes/twentyfifteen-child/img/cliffs.jpg" alt=""/>
						<div className="overlay">
					    <div className="projectInfo">
								<h4>Travel</h4>
